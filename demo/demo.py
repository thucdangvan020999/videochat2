...
def init_model():
    ...
    state_dict = torch.load(
        "/home/thucdv/Downloads/videochat2_mistral_7b_stage3.pth", "cuda"
    )
...
def gradio_reset(chat_state, img_list):
    ...
    return (
        ...
        gr.update(value=None, interactive=True),
        gr.update(
            placeholder="Please upload your video first", interactive=False
        ),
...
def upload_img(gr_img, gr_video, chat_state, num_segments):
    ...
    if gr_img is None and gr_video is None:
        return (
            ...
            gr.update(
                interactive=True, placeholder="Please upload video/image first!"
            ),
            chat_state,
            None,
        )
